...
# time Rscript /projects/jonatan/wgcna-src/rwgcna-pipeline/rwgcna_main.R  --seurat_path /projects/jonatan/tmp-holst-hsl/RObjects/campbell_all_author_ids.RData   --project_dir /projects/jonatan/tmp-rwgcna-tests/campbell_2/  --data_prefix campbell_2 --data_organism mmusculus  --magma_gwas_dir /projects/jonatan/tmp-bmi-brain/data/magma/BMI-brain/ --min.cells 5  --genes_use PCA  --pca_genes all  --corFnc bicor  --networkType signed  --hclustMethod average  --minClusterSize "c(15)"  --deepSplit "c(0,1,2,3)"  --pamStage "c(FALSE,TRUE)"  --moduleMergeCutHeight "c(0.1)"  --jackstrawnReplicate 500  --TOMnReplicate 50  --n_cores 10  --autosave T --fuzzyModMembership kIM --checkPPI T --resume checkpoint_1
...
#  time Rscript /projects/jonatan/wgcna-src/rwgcna-pipeline/rwgcna_main.R --seurat_path /projects/jonatan/tmp-epilepsy/RObjects/seurat_obj_filter_ensembl_lake.RData --project_dir /projects/jonatan/tmp-rwgcna-tests/tmp-epilepsy-lake-4/ --metadata_subset_col "res.0.6"   --magma_gwas_dir /projects/jonatan/tmp-epilepsy/data/magma/ilae-lancet-2014/ --data_prefix EP-lake-4 --min.cells 6 --genes_use PCA --pca_genes all --corFnc cor --networkType signed --minClusterSize "c(15)" --deepSplit "c(3)" --pamStage "c(FALSE)" --moduleMergeCutHeight "c(0.1)" --jackstrawnReplicate 500 --TOMnReplicate 0 --data_organism hsapiens --n_cores 5 --autosave T --resume checkpoint_2 --checkPPI F --regress_out "c('nUMI', 'percent.mito')" --fuzzyModMembership kIM 
#  time Rscript /projects/jonatan/wgcna-src/rwgcna-pipeline/rwgcna_main.R --seurat_path /projects/jonatan/tmp-epilepsy/RObjects/seurat_obj_filter_ensembl_UPF.RData --project_dir /projects/jonatan/tmp-rwgcna-tests/tmp-epilepsy-UPF-4/ --metadata_subset_col "res.0.6"  --magma_gwas_dir /projects/jonatan/tmp-epilepsy/data/magma/ilae-lancet-2014/ --data_prefix EP-UPF-4 --min.cells 6 --genes_use PCA --pca_genes all --corFnc cor --networkType signed --minClusterSize "c(15)" --deepSplit "c(3)" --pamStage "c(FALSE)" --moduleMergeCutHeight "c(0.1)" --jackstrawnReplicate 500 --TOMnReplicate 0  --data_organism hsapiens --n_cores 10 --autosave T --resume checkpoint_1 --checkPPI F --regress_out "c('nUMI', 'percent.mito')" --fuzzyModMembership kIM
...
#  time Rscript /projects/jonatan/wgcna-src/rwgcna-pipeline/rwgcna_main.R --seurat_path /projects/jonatan/tmp-epilepsy/RObjects/seurat_obj_filter_ensembl_lake.RData --project_dir /projects/jonatan/tmp-rwgcna-tests/tmp-epilepsy-lake-4/ --metadata_subset_col "res.0.6" --metadata_corr_col "c('dataset')" --metadata_corr_filter_vals "c('UPF')"  --magma_gwas_dir /projects/jonatan/tmp-bmi-brain/data/magma/BMI-brain/ --data_prefix EP-lake-4 --min.cells 6 --genes_use PCA --pca_genes all --corFnc cor --networkType signed --minClusterSize "c(15)" --deepSplit "c(3)" --pamStage "c(FALSE)" --moduleMergeCutHeight "c(0.1)" --jackstrawnReplicate 500 --TOMnReplicate 100 --data_organism hsapiens --n_cores 15 --autosave T
#  time Rscript /projects/jonatan/wgcna-src/rwgcna-pipeline/rwgcna_main.R --seurat_path /projects/jonatan/tmp-epilepsy/RObjects/seurat_obj_filter_ensembl_UPF.RData --project_dir /projects/jonatan/tmp-rwgcna-tests/tmp-epilepsy-UPF-4/ --metadata_subset_col "res.0.6" --metadata_corr_col "c('dataset')" --metadata_corr_filter_vals "c('UPF')" --magma_gwas_dir /projects/jonatan/tmp-bmi-brain/data/magma/BMI-brain/ --data_prefix EP-UPF-4 --min.cells 6 --genes_use PCA --pca_genes all --corFnc cor --networkType signed --minClusterSize "c(15)" --deepSplit "c(3)" --pamStage "c(FALSE)" --moduleMergeCutHeight "c(0.1)" --jackstrawnReplicate 500 --TOMnReplicate 100  --data_organism hsapiens --n_cores 15 --autosave T


# time Rscript /projects/jonatan/wgcna-src/rwgcna-pipeline/rwgcna_main.R --seurat_path /projects/jonatan/tmp-bmi-brain/data/hypo_topBMI.Rdata --project_dir /projects/jonatan/tmp-rwgcna-tests/hypo_topBMI_4/  --data_prefix hypo_topBMI_4  --use.imputed FALSE --min.cells 5  --genes_use PCA --pca_genes all --corFnc cor --networkType signed --hclustMethod average --minClusterSize "c(15)" --deepSplit "c(3)" --pamStage "c(FALSE)" --moduleMergeCutHeight "c(0.1)" --jackstrawnReplicate 500 --TOMnReplicate 0  --data_organism mmusculus --magma_gwas_dir /projects/jonatan/tmp-bmi-brain/data/magma/BMI-brain/ --n_cores 18 --autosave TRUE 
