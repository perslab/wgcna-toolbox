...
project_dir = "/projects/jonatan/tmp-rwgcna-tests/mouse_top10_8/"
data_prefix = "mouse_top10"
run_prefix = "8"
...
```{r}
params_run <- read.table(sprintf("%s%s_%s_params_run.tab", log_dir, data_prefix, run_prefix), sep = "\t", quote = "", header=T)
