...
data_prefix = "mousebrain_top10_5"
...
```{r}
source(file = "/projects/jonatan/functions-src/functions_dev.R")
```
...
pdf(sprintf("%s%s_%s_cellModEmbed_cellOrder_%s.pdf", plots_dir, data_prefix, fuzzyModMembership, flag_date ),h=nrow(cellModEmbed_mat) %/% 1000, w=ncol(cellModEmbed_mat) %/% 2)
draw(ht1+htra)
dev.off()
...
ht2 <- Heatmap(cellModEmbed_mat_sqrt[,], 
             ...
             heatmap_legend_param = list(title = "Expression"))
             #top_annotation = eval(parse(text = paste0("list_htca_fdr", "[[", 1:length(list_htca_fdr),"]]"))))
pdf(sprintf("%s%s_%s_cellModEmbed_cellOrder_sqrt%s.pdf", plots_dir, data_prefix, fuzzyModMembership, flag_date ),h=nrow(cellModEmbed_mat) %/% 1000, w=ncol(cellModEmbed_mat) %/% 2)
draw(ht2+htra)
dev.off()
...
ht3 <- Heatmap(cellModEmbed_mat[,], 
               ...
               heatmap_legend_param = list(title = "Expression"))
               #top_annotation = eval(parse(text = paste0("list_htca_fdr", "[[", 1:length(list_htca_fdr),"]]"))))
pdf(sprintf("%s%s_%s_cellModEmbed_cellCluster_%s.pdf", plots_dir, data_prefix, fuzzyModMembership,  flag_date ),h=nrow(cellModEmbed_mat) %/% 1000, w=ncol(cellModEmbed_mat) %/% 2)
draw(ht3+htra)
dev.off()
...
ht4 <- Heatmap(cellModEmbed_mat_sqrt[,], 
               ...
               heatmap_legend_param = list(title = "Expression"))
               #top_annotation = eval(parse(text = paste0("list_htca_fdr", "[[", 1:length(list_htca_fdr),"]]"))))
pdf(sprintf("%s%s_%s_cellModEmbed_sqrt_cellCluster_%s.pdf", plots_dir, data_prefix, fuzzyModMembership, flag_date ),h=nrow(cellModEmbed_mat) %/% 1000, w=ncol(cellModEmbed_mat) %/% 2)
draw(ht4+htra)
dev.off()
...
ht5 <- Heatmap(cellModEmbed_mat[,], 
               ...
               heatmap_legend_param = list(title = "Expression"))
               #top_annotation = eval(parse(text = paste0("list_htca_fdr", "[[", 1:length(list_htca_fdr),"]]"))))
pdf(sprintf("%s%s_%s_cellModEmbed_RowColOrder_%s.pdf", plots_dir, data_prefix, fuzzyModMembership,  flag_date ),h=nrow(cellModEmbed_mat) %/% 1000, w=ncol(cellModEmbed_mat) %/% 2)
draw(ht5+htra)
dev.off()  
...
ht6 <- Heatmap(cellModEmbed_mat_sqrt[,], 
               ...
               heatmap_legend_param = list(title = "Expression"))
               #top_annotation = eval(parse(text = paste0("list_htca_fdr", "[[", 1:length(list_htca_fdr),"]]"))))
pdf(sprintf("%s%s_%s_cellModEmbed_sqrt_RowColOrder_%s.pdf", plots_dir, data_prefix, fuzzyModMembership, flag_date ),h=nrow(cellModEmbed_mat) %/% 1000, w=ncol(cellModEmbed_mat) %/% 2)
draw(ht6+htra)
dev.off()  
```
...
# Compute kMs of the merged modules
